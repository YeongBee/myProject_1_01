const posts = [
    ...
    },
    {
        ...
        content: "        1. !bot 를 사용하여 저장된 명령들을 실행할 수 있습니다.\n(ex : !bot 안녕 )\n\n" +
            ...
            "                5. !메이플 을 사용하여 캐릭터의 정보를 볼 수 있습니다.\n (!명령어 (캐릭터이름) )\n                (ex : !메이플 아델 )\n\n" +
            "                6. !스타포스 를 사용하여 계정의 스타포스에 사용한 비용을 확인할 수 있습니다.\n 자신의 API가 필요합니다. API는 한번 저장하면 영구적으로 저장 가능합니다.\n ( ex : !스타포스 )\n ( ex : !api저장 live_apikey.... )\n ( ex : !api삭제 )\n\n" +
            "                7. !잠재능력 을 사용하여 계정의 잠재능력에 사용한 비용을 알 수 있습니다. \n자신의 API가 필요합니다. \n( ex : !잠재능력)\n\n"+
            "                8. !큐브 를 사용하여 사용한 큐브의 종류와 개수를 알 수 있습니다. \n자신의 API가 필요합니다. \n (ex : !큐브)"
    },
    {title: "제작자", content: "제작자 : Yeongbee \n\n Email : cyeongbb@gmail.com"}
